...
const TR: Record<string, { title: string; script: string[] }> = {
  'morning-light': {
    ...
    script: [
      ...
      'Rab, bu sabah, aldığım nefes ve yeni başlangıç için teşekkür ederim.',
  ...
  'calm-the-storm': {
    ...
    script: [
      'Elini kalbinin üzerine koy. Atışını hisset; hayattasın ve korunuyorsun.',
  ...
  'grateful-heart': {
    ...
    script: [
      'Bugün güzel olan bir şeyi düşün; ne kadar küçük olursa olsun. Bir an onunla kal.',
      'Baba, her iyi armağan Senden gelir. Teşekkür ederim.',
      'Dua edip aldıklarım ve fark etmeden korunduğum şeyler için teşekkür ederim.',
  ...
  'bless-my-family': {
    ...
    script: [
      ...
      'Baba, her birini sağlıkta, yürekte ve imanda bereketle.',
  ...
  'courage-for-today': {
    ...
    script: [
      ...
      'Güçlü ve cesur olacağım; yalnız değilim, Sen benimlesin. Âmin.',
    ],
  },
  'gratitude-evening': {
  ...
  'peace-of-christ': {
    ...
    script: [
      ...
      'İsa, bize huzurunu bıraktın; dünyanın verdiği gibi değil, gerçek ve derin bir huzur.',
  ...
  'strength-to-forgive': {
    ...
    script: [
      ...
      'İsmi, anıyı ve yarayı Sana getiriyorum; ellerine bırakıyorum.',
  ...
  'sleep-psalm': {
    ...
    script: [
      ...
      'Gecenin korkusu da yarının kaygısı da yok; yalnızca Senin koruman var.',
...
const NL: Overlay = {
  'morning-light': { title: 'Ochtendlicht', script: ['Adem langzaam in… en uit. Wees hier voordat de dag iets van je vraagt.', 'Heer, dank U voor deze ochtend, voor adem en voor een nieuw begin.', 'Ik geef U de uren die voor me liggen: mijn werk, mijn woorden en de mensen die ik ontmoet.', 'Waar ik angstig ben, wees mijn vrede. Waar ik moe ben, wees mijn kracht.', 'Laat mij zonder haast door deze dag gaan, wetend dat U dichtbij bent. Amen.'] },
  'calm-the-storm': { title: 'Kalmeer de Storm', script: ['Leg een hand op je hart. Voel het kloppen: je leeft en je wordt gedragen.', 'Jezus, U sliep in een storm en bracht hem met een woord tot rust. Spreek ook tot de mijne.', 'Ik benoem nu mijn zorg… en leg haar in Uw handen.', 'Laat Uw vrede over mijn gedachten komen als stil water.', 'Vandaag laat ik mij niet door angst dragen. U draagt mij. Amen.'] },
  'grateful-heart': { title: 'Een Dankbaar Hart', script: ['Denk aan één goed ding van vandaag, hoe klein ook. Houd het even vast.', 'Vader, elk goed geschenk komt van U. Dank U.', 'Dank U voor wat ik vroeg en ontving, en voor wat mij bespaard bleef.', 'Leer mij genade op te merken in gewone uren.', 'Laat dankbaarheid de toon zijn waarop mijn dag eindigt. Amen.'] },
  'into-rest': { title: 'Naar de Rust', script: ['Laat de dag eindigen. Je hebt gedaan wat je kon, en dat is genoeg.', 'Heer, terwijl ik ga liggen, leg ik wat onaf is in Uw zorg.', 'Waak over de mensen van wie ik houd terwijl we slapen.', 'Geef mij vrede om te gaan liggen en veilig te rusten onder Uw zorg.', 'Vertraag mijn adem… maak mijn gedachten stil… en houd mij vast tot de ochtend. Amen.'] },
  'bless-my-family': { title: 'Zegen Mijn Familie', script: ['Haal de gezichten van je familie één voor één voor je.', 'Vader, zegen ieder van hen in gezondheid, hart en geloof.', 'Genees wat tussen ons gespannen is; verzacht wat hard is geworden.', 'Maak van ons huis een plek van geduld en lachen.', 'Bind ons samen in Uw liefde. Amen.'] },
  'courage-for-today': { title: 'Moed voor Vandaag', script: ['Sta even rechtop. Adem diep.', 'Heer, vorm in mij geen geest van angst maar van kracht, liefde en bezonnenheid.', 'Geef mij moed voor het gesprek, de taak en de stap die ik blijf uitstellen.', 'Als ik wankel, herinner mij eraan dat U voor mij uitgaat.', 'Ik kies voor moed, niet alleen maar met U. Amen.'] },
  'gratitude-evening': { title: 'De Gaven Tellen', script: ['Laat de dag tot rust komen. Adem uit wat hij van je vroeg.', 'Vader, laat mij vóór mijn tekorten eerst benoemen wat mij gegeven is.', 'Dank U voor de gewone genade waar ik vandaag bijna aan voorbijging.', 'Dank U voor de mensen die mijn leven warmer maken.', 'Een dankbaar hart is een vol hart. Vul het mijne vanavond. Amen.'] },
  'still-waters': { title: 'Stille Wateren', script: ['Ontspan je handen. Laat je adem bij elke regel vertragen.', 'Herder, U leidt mij naar stille wateren. Leid mij daar nu heen.', 'De gedachten die in mij rondjagen leg ik één voor één aan Uw voeten.', 'Herstel mijn ziel en wat vandaag dun is geworden.', 'Ik hoef niet bang te zijn, want U bent bij mij. Amen.'] },
  'morning-surrender': { title: 'Voor de Dag', script: ['De dag ligt nog voor je. Ontmoet hem hier eerst met God.', 'Heer, deze dag is van U voordat hij van mij is.', 'Ga mij voor in elke ruimte die ik betreed en in elk woord dat ik spreek.', 'Wanneer haast mij trekt, leer mij rustig te gaan.', 'Orden mijn uren en houd mijn hart dicht bij het Uwe. Amen.'] },
  'peace-of-christ': { title: 'Vrede die Bewaakt', script: ['Zet beide voeten op de grond. Jij bent hier. God is hier.', 'Jezus, U geeft een vrede die dieper gaat dan wat de wereld kan geven.', 'Laat die vrede vandaag mijn hart en gedachten bewaken.', 'Wat ik niet kan beheersen, geef ik aan U.', 'Uw vrede is genoeg. Daarin rust ik. Amen.'] },
  'gratitude-morning': { title: 'Eerste Dank', script: ['Voor de takenlijst: één pauze. Eén adem van dank.', 'Vader, dank U dat U mij wakker maakte voor een nieuwe dag van genade.', 'Dank U voor adem, licht en een nieuwe bladzijde.', 'Laat dankbaarheid, niet haast, de toon van mijn ochtend zetten.', 'Ik begin vandaag dankbaar. Amen.'] },
  'rest-for-the-weary': { title: 'Leg Het Neer', script: ['De dag is voorbij. Je hebt gedaan wat je kon, en dat is genoeg.', 'Heer, ik leg alles wat onaf is in Uw zorg.', 'De zorgen die ik de nacht in zou dragen laat ik bij U.', 'Geef mij de rust die ik nu nodig heb.', 'In vrede ga ik liggen, omdat U mij bewaart. Amen.'] },
  'for-my-children': { title: 'Over Wie Ik Liefheb', script: ['Denk aan ieder mens van wie je houdt. Houd zijn of haar gezicht even voor je.', 'Vader, waak over wie aan mij zijn toevertrouwd.', 'Bewaar hun gaan en hun thuiskomen.', 'Waar ik tekortschiet, laat Uw genade de ruimte vullen.', 'Houd hen in Uw hand, dichter dan ik ooit zou kunnen. Amen.'] },
  'strength-to-forgive': { title: 'Kracht om te Vergeven', script: ['Adem. Dit is moeilijk, en God weet het.', 'Heer, U hebt mij vergeven. Geef mij kracht om ook te vergeven.', 'Ik breng de naam, de herinnering en de wond bij U.', 'Bevrijd mij van het dragen van wat nooit mijn last hoefde te zijn.', 'Genees wat vergeving opent. Maak mij heel. Amen.'] },
  'sleep-psalm': { title: 'Onder Zijn Vleugels', script: ['Voel het gewicht van de dag van je schouders zakken.', 'Bij de Allerhoogste is een veilige schuilplaats en rust.', 'Heer, bedek mij vannacht zoals een vogel zijn jongen beschermt.', 'Geen angst voor de nacht, geen zorgen over morgen — alleen Uw zorg.', 'Ik hoef niet bang te zijn. Goede nacht, Vader. Amen.'] },
  'when-i-am-weak': { title: 'Wanneer Ik Zwak Ben', script: ['Hier hoef je niet te doen alsof je sterk bent.', 'Heer, Uw kracht ontmoet mij juist in mijn zwakheid.', 'Hier is mijn zwakheid; ik verberg haar niet langer voor U.', 'Wees sterk op de plek waar ik niets meer over heb.', 'Uw genade is genoeg voor mij. Amen.'] },
...
const OVERLAYS: Partial<Record<Exclude<Locale, 'en'>, Overlay>> = { tr: TR, es: ES, pt: PT, fr: FR, de: DE, it: IT, nl: NL };
