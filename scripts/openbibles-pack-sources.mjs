...
export const OPEN_BIBLES_PACK_SOURCES = {
  ...
  bg: { file: 'bul-bulgarian.osis.xml', format: 'osis', edition: 'Rejected Bulgarian source', rights: 'rejected-source-mismatch', structuralStatus: 'pass', blocker: 'text matches copyrighted Veren contemporary edition' },
  ...
  th: { file: 'tha-thai.osis.xml', format: 'osis', edition: 'Rejected Thai source', rights: 'rejected-source-mismatch', structuralStatus: 'pass', blocker: 'text matches copyrighted Thai KJV edition' },
